...
public class General_purpose_calc
{
    public static void main(String[] args)
    {
        ...
        else if(ch1 == 2) //This part gets executed if user enters "3"
        {
            int vnum = 0;
            ...
            case 2 :double t1 = 0; double t2 = 0; //Always use double type for making any kind of calculator as int does not allow use of decimals, and gives a type miss match error when a decimal term is entered
                ...
                break;
                default : System.out.println(" ERROR --> 5 or more terms are not supported ");       
            }
        }
        else if(ch1 == 3) //This part gets executed if user enters "4"
        {
        ...
        else if(ch1 == 4) //This part is executed if user enters "5"
        {
            int cp = 0,sp = 0;
